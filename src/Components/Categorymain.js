...
function Categorymain() {
  return (
    ...
    <div id="block">
        ...
        <Link id="text" to="/kathak"> <div className="blurry-background" style={{backgroundImage: `url(${kathak1})`}}>
            <h2>Kathak</h2>
            </div> </Link>
            <div className="blurry-background" style={{backgroundImage: `url(${hiphop})`}}>
            <h2> HIP-HOP</h2>
            </div>
            <div className="blurry-background" style={{backgroundImage: `url(${tapdance})`}}>
            <h2>Tap Dance</h2>
            </div>
            <div className="blurry-background" style={{backgroundImage: `url(${contemporary})`}}>
            <h2>Contemporary</h2>
            </div>
        </div>

        <div className='dance-categories2'>
        <div className="blurry-background2" style={{backgroundImage: `url(${jazzdance})`}}>
        <h2>Jazz Dance</h2>
        </div>
        <div className="blurry-background2" style={{backgroundImage: `url(${jazzdance})`}}>
        <h2>Jazz Dance</h2>
